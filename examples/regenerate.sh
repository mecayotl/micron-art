...
#
#   PYTHONPATH=src/cli python3 -m micronart \
#       -m literal  examples/art/gallery-mono.txt
#   PYTHONPATH=src/cli python3 -m micronart \
#       -m escaped  examples/art/gallery-mono.txt
#   PYTHONPATH=src/cli python3 -m micronart \
#       -m escaped  examples/art/gallery-color.ans
#   PYTHONPATH=src/cli python3 -m micronart \
#       -m escaped  examples/art/gallery-hazard.txt
